VARIATION IN DESIGN ACCURACY DUE TO RANDOMNESS IN DESIGN GENERATION

AutoBreak was used to generate 5 design variants that have different crossover patterns but are otherwise identical.

Random seeds 0-4 were used. Other settings had default values.

ACCURACY COMPARISON FOR MANUALLY ALTERED GRADIENTS

DESIGNS

MagicDNA was used to generate split ring (R=20nm) designs with a 3x6 square lattice cross section using the extrude method. Gradient magnitudes were then manually swept from 1 bp to 6 bp, with an increment of one. The default value was 3 bp.

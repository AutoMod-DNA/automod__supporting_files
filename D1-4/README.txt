...
Designs corresponding to four target shapes (D1-4) with varying honeycomb cross sections were generated with AutoMod (v0.0.7) and MagicDNA (v2.0.2 used with MATLAB R2024b).
...
D1:	planar figure 8
D2:	spiral with constant rise and radius of curvature
D3:	spiral with constant rise and varying curvature
D4:	planar spiral

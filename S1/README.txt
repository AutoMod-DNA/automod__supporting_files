DEPENDENCE OF GLOBAL CURVATURE ON CROSSOVER DENSITY

DESIGNS

The AutoMod split ring design from the accuracy comparison across all design methods was regenerated with otherwise identical settings, except that the target value for mean crossover density was swept from 0.40 (1/bp) to 0.80 (1/bp) using increments of 0.10 (1/bp).
